...
#set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { digsel[7] }]; #IO_L24N_T3_34 Sch=sw[8]
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { digsel[6] }]; #IO_25_34 Sch=sw[9]
#set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { digsel[5] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
#set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { digsel[4] }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { digsel[3] }]; #IO_L24P_T3_35 Sch=sw[12]
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { digsel[2] }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
#set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { digsel[1] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { digsel[0] }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict {PACKAGE_PIN L23 IOSTANDARD LVCMOS33} [get_ports {DisplayCoche[0]}]
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports {DisplayCoche[1]}]
set_property -dict {PACKAGE_PIN J23 IOSTANDARD LVCMOS33} [get_ports {DisplayCoche[2]}]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports {DisplayCoche[3]}]
set_property -dict {PACKAGE_PIN K23 IOSTANDARD LVCMOS33} [get_ports {DisplayCoche[4]}]
set_property -dict {PACKAGE_PIN K22 IOSTANDARD LVCMOS33} [get_ports {DisplayCoche[5]}]
set_property -dict {PACKAGE_PIN L22 IOSTANDARD LVCMOS33} [get_ports {DisplayCoche[6]}]
set_property -dict {PACKAGE_PIN J25 IOSTANDARD LVCMOS33} [get_ports {DisplayCoche[7]}]


##Buttons


set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports BotonIzq]
...
set_property IOSTANDARD LVCMOS33 [get_ports {posicionOUT[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {posicionOUT[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {posicionOUT[0]}]
...
set_property PACKAGE_PIN H21 [get_ports {Segmentos[6]}]
set_property PACKAGE_PIN G21 [get_ports {Segmentos[5]}]
set_property PACKAGE_PIN H23 [get_ports {Segmentos[4]}]
set_property PACKAGE_PIN H24 [get_ports {Segmentos[3]}]
set_property PACKAGE_PIN J21 [get_ports {Segmentos[2]}]
set_property PACKAGE_PIN H22 [get_ports {Segmentos[1]}]
set_property PACKAGE_PIN J24 [get_ports {Segmentos[0]}]
